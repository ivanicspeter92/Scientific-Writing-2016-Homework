...
Clean Code is a concept introduced by Robert C. Martin \cite{cleancode} \cite{cleancoder}. This approach to software development brings elegant, easy to read program code in light in order to create robust, bug-free applications \cite{cleancode}. Additionally, refactoring further increases quality of software \cite{impactofrefactoring}, which developers should not be afraid of \cite{cleancoder}. 
