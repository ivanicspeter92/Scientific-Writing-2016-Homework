...
\section{Discussion}
	\subsection{Sketches & Storyboards}
	Two sketches were made for the application, displayed respectively on Figures \ref{sketch-1} and \ref{sketch-2}. The following paragraphs briefly describe these sketches, the possible user interactions and the transitions between the screens. 
