...
\section{Map Matching}
	\begin{enumerate}[a)]
		\item Figure \ref{interpolated_points} displays the original points (black) and the new ones added using interpolation technique (red). Using 10 seconds sampling interval, 452 points are added in total. 
