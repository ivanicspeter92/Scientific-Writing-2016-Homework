...
\subsection{Results}
    ...
    The EDA fundamentally focused on two aspects of the data at hand: the content and the user profiles and the distributions of the features of these entities. First, the findings related to the content, then the user profiles in the Choicely platform are presented in the paragraphs to follow. 
